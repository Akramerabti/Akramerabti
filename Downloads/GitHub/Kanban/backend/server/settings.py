...
SECRET_KEY = 'django-insecure-+uc!m*ewx^k_6#!mjjnt*vgh8yo%1@st5_w9%a@e9=hqx77@wm'
...
INSTALLED_APPS = [
    ...
    'kanban_board.apps.KanbanBoardConfig',
    'rest_framework',
    'corsheaders',
]
...
CORS_ALLOWED_ORIGINS = CORS_ORIGIN_WHITELIST = CSRF_TRUSTED_ORIGINS = ["http://localhost:5173"]
